...
import { Ionicons } from '@expo/vector-icons'; // nova dependencia, documentar depois
import { AnimatedCircularProgress } from 'react-native-circular-progress'; // nova dependencia, documentar depois
...
const styles = StyleSheet.create({
  ...
  titulo: { fontSize: 26, fontWeight: 'bold', color: '#000', marginBottom: 30 },
  centroCirculo: { alignItems: 'center', justifyContent: 'center' },
  textoLitros: { fontSize: 22, fontWeight: 'bold', color: '#000', marginTop: 8 },
  textoMeta: { fontSize: 14, color: '#666' },
